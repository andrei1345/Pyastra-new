############################################################################
# $Id: 16f818i.py 95 2004-11-28 18:50:38Z estyler $
#
# Description: PIC 16F818I definition. Pyastra project.
...
banks=((0x20, 0x3F), (0x40, 0x64), (0x71, 0x7F), (0xA0, 0xBF), )

shareb=(
        ((0x20, 0x3F), (0x120, 0x13F), (0x1A0, 0x1BF), ),
        ((0x40, 0x64), (0xC0, 0xE4), (0x140, 0x164), (0x1C0, 0x1E4), ),
