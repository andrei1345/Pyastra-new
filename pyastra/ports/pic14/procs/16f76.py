############################################################################
# $Id: 16f76.py 70 2004-08-23 01:34:19Z estyler $
#
# Description: PIC 16F76 definition. Pyastra project.
...
hdikt={'RCIF': 0x5, 'NOT_T1SYNC': 0x2, 'BF': 0x0,
       ...
       'ADCON0': 0x1f, 'OPTION_REG': 0x81, 'PIR2': 0xd,
       'PIR1': 0xc, 'INTE': 0x4, 'OERR': 0x1,
       'PSA': 0x3, 'S': 0x3, 'I2C_READ': 0x2,
       'CREN': 0x4, 'CCP2M1': 0x1, 'CCP2M0': 0x0,
       'CCP2M3': 0x3, 'CCP2M2': 0x2, 'UA': 0x1,
       'RBIF': 0x0, 'RBIE': 0x3, 'TXREG': 0x19,
       'T1OSCEN': 0x3, 'PCLATH': 0xa, 'SSPSTAT': 0x94,
       'PCON': 0x8e, 'TOUTPS2': 0x5, 'TOUTPS3': 0x6,
       'TOUTPS0': 0x3, 'TOUTPS1': 0x4, 'FSR': 0x4,
       'PMDATA': 0x10c, 'NOT_W': 0x2, 'RX9D': 0x0,
       'PMDATH': 0x10e, 'SSPOV': 0x6, 'T0IF': 0x2,
       'RD': 0x0, 'CCP1CON': 0x17, 'RCREG': 0x1a,
       'ADCS0': 0x6, 'ADRES': 0x1e, 'CKE': 0x6,
       'DATA_ADDRESS': 0x5, 'D_A': 0x5, 'INTF': 0x1,
       'FERR': 0x2, 'TMR2IE': 0x1, 'TMR2IF': 0x1,
       'NOT_BO': 0x0, 'R': 0x2, 'ADIE': 0x6,
       'ADIF': 0x6, 'Z': 0x2, 'NOT_WRITE': 0x2,
       'SSPADD': 0x93, 'NOT_DONE': 0x2, 'TXEN': 0x5,
       ...
       'TRMT': 0x1, 'PS1': 0x1, 'SSPEN': 0x5,
       'GO_DONE': 0x2, 'WCOL': 0x7, 'RP1': 0x6,
       'RP0': 0x5, 'T1CKPS1': 0x5, 'T1CKPS0': 0x4,
       'IRP': 0x7, 'CCP1IE': 0x2, 'CCP1X': 0x5,
       'CCP1Y': 0x4, 'CSRC': 0x7, 'TX9': 0x6,
       'TMR2ON': 0x2, 'TMR1IF': 0x0, 'TMR1IE': 0x0,
       'SSPM0': 0x0, 'SSPM1': 0x1, 'SSPM2': 0x2,
       'SSPM3': 0x3, 'PMADR': 0x10d, 'I2C_START': 0x3,
       'NOT_ADDRESS': 0x5, 'PMADRH': 0x10f, 'INDF': 0x0,
