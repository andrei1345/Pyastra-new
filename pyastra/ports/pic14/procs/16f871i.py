############################################################################
# $Id: 16f871i.py 95 2004-11-28 18:50:38Z estyler $
#
# Description: PIC 16F871I definition. Pyastra project.
...
hdikt={'RCIF': 0x5, 'NOT_T1SYNC': 0x2, 'RCIE': 0x5,
       ...
       'TRISE1': 0x1, 'TRISE0': 0x0, 'RX9D': 0x0,
       'T0IF': 0x2, 'RX9': 0x6, 'CCP1CON': 0x17,
       'RCREG': 0x1a, 'EEDATH': 0x10e, 'EEDATA': 0x10c,
       'IBOV': 0x5, 'EEADRH': 0x10f, 'OBF': 0x6,
       ...
       'IBF': 0x7, 'NOT_BOR': 0x0, 'FERR': 0x2,
       'RCSTA': 0x18, 'EEADR': 0x10d, 'PS1': 0x1,
       'ADCS0': 0x6, 'GO_DONE': 0x2, 'STATUS': 0x3,
       'RP0': 0x5, 'T1CKPS1': 0x5, 'INTF': 0x1,
       'EEPGD': 0x7, 'IRP': 0x7, 'CCP1IE': 0x2,
       'CCP1X': 0x5, 'CCP1Y': 0x4, 'SREN': 0x5,
       'CSRC': 0x7, 'TX9': 0x6, 'TMR2ON': 0x2,
       'TMR1IF': 0x0, 'TMR1IE': 0x0, 'INDF': 0x0,
       'NOT_POR': 0x1, 'TX9D': 0x0, }
