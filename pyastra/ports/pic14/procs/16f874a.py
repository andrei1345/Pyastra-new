############################################################################
# $Id: 16f874a.py 70 2004-08-23 01:34:19Z estyler $
#
# Description: PIC 16F874A definition. Pyastra project.
...
hdikt={'RCIF': 0x5, 'NOT_T1SYNC': 0x2, 'BF': 0x0,
       ...
       'CVR2': 0x2, 'CCP2CON': 0x1d, 'CCPR2L': 0x1b,
       'D': 0x5, 'CVRCON': 0x9d, 'PORTD': 0x8,
       ...
       'EEDATA': 0x10c, 'DATA_ADDRESS': 0x5, 'C1OUT': 0x6,
       'TMR1IE': 0x0, 'D_A': 0x5, 'WREN': 0x2,
       'EEADRH': 0x10f, 'OBF': 0x6, 'FERR': 0x2,
       ...
       'IBF': 0x7, 'NOT_BOR': 0x0, 'TMR1ON': 0x0,
       'RCSTA': 0x18, 'R_W': 0x2, 'EEADR': 0x10d,
       'TRMT': 0x1, 'PS1': 0x1, 'SSPEN': 0x5,
       'ACKEN': 0x4, 'GO_DONE': 0x2, 'CMCON': 0x9c,
       'WCOL': 0x7, 'STATUS': 0x3, 'RP0': 0x5,
       'T1CKPS1': 0x5, 'INTF': 0x1, 'EEIE': 0x4,
       'EEPGD': 0x7, 'EEIF': 0x4, 'IRP': 0x7,
       'CCP1IE': 0x2, 'CCP1X': 0x5, 'CCP1Y': 0x4,
       'CMIE': 0x6, 'SREN': 0x5, 'CSRC': 0x7,
...
shareb=(
        ((0xA0, 0xFF), (0x1A0, 0x1FF), ),
        ((0x20, 0x7F), (0x120, 0x17F), ),
)
