############################################################################
# $Id: 16cr63.py 70 2004-08-23 01:34:19Z estyler $
#
# Description: PIC 16CR63 definition. Pyastra project.
...
hdikt={'RCIF': 0x5, 'NOT_T1SYNC': 0x2, 'BF': 0x0,
       'RCIE': 0x5, 'CKP': 0x4, 'T2CON': 0x12,
       'T1CON': 0x10, 'T0SE': 0x4, 'SPBRG': 0x99,
       'RX9': 0x6, 'PIE2': 0x8d, 'PIE1': 0x8c,
       ...
       'PS2': 0x2, 'PS0': 0x0, 'TMR1H': 0xf,
       'TMR1L': 0xe, 'CCP1M2': 0x2, 'CCP1M3': 0x3,
       'CCP1M0': 0x0, 'CCP1M1': 0x1, 'TMR1CS': 0x1,
       'CCP1IF': 0x2, 'NOT_RBPU': 0x7, 'I2C_STOP': 0x4,
       'C': 0x0, 'TRISC': 0x87, 'TRISB': 0x86,
       'TRISA': 0x85, 'OPTION_REG': 0x81, 'PIR2': 0xd,
       'PIR1': 0xc, 'OERR': 0x1, 'RP1': 0x6,
       ...
       'DATA_ADDRESS': 0x5, 'D_A': 0x5, 'FERR': 0x2,
       ...
       'CCPR1H': 0x16, 'T0IE': 0x5, 'NOT_PD': 0x3,
       'DC': 0x1, 'NOT_BOR': 0x0, 'TMR1ON': 0x0,
       ...
       'TMR1IE': 0x0, 'SSPM0': 0x0, 'SSPM1': 0x1,
