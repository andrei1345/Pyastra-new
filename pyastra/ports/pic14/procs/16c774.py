############################################################################
# $Id: 16c774.py 70 2004-08-23 01:34:19Z estyler $
#
# Description: PIC 16C774 definition. Pyastra project.
...
hdikt={'RCIF': 0x5, 'NOT_T1SYNC': 0x2, 'BF': 0x0,
       ...
       'BGST': 0x5, 'T0CS': 0x5, 'ADRESL': 0x9e,
       'SSPBUF': 0x13, 'ADRESH': 0x1e, 'VCFG1': 0x5,
       'TXIF': 0x4, 'TXIE': 0x4, 'VCFG2': 0x6,
       'SPEN': 0x7, 'LVDCON': 0x9c, 'ACKDT': 0x5,
       ...
       'TRISE0': 0x0, 'NOT_W': 0x2, 'RX9D': 0x0,
       'SSPOV': 0x6, 'ADCS0': 0x6, 'T0IF': 0x2,
       'CCP1CON': 0x17, 'RCREG': 0x1a, 'SREN': 0x5,
       'CKE': 0x6, 'DATA_ADDRESS': 0x5, 'TMR1IE': 0x0,
       'D_A': 0x5, 'OBF': 0x6, 'FERR': 0x2,
       ...
       'TMR0': 0x1, 'VRLOEN': 0x4, 'BRGH': 0x2,
       'VCFG0': 0x4, 'CCP2IE': 0x0, 'CCPR1L': 0x15,
       'READ_WRITE': 0x2, 'CCP2IF': 0x0, 'CCPR1H': 0x16,
       'T0IE': 0x5, 'ADCS1': 0x7, 'PEN': 0x2,
       'NOT_PD': 0x3, 'DC': 0x1, 'IBF': 0x7,
       'NOT_BOR': 0x0, 'LVDEN': 0x4, 'TMR1ON': 0x0,
       'RCSTA': 0x18, 'R_W': 0x2, 'TRMT': 0x1,
       'PS1': 0x1, 'LV1': 0x1, 'LV0': 0x0,
       'SSPEN': 0x5, 'ACKEN': 0x4, 'GO_DONE': 0x2,
       'WCOL': 0x7, 'STATUS': 0x3, 'RP0': 0x5,
       'T1CKPS1': 0x5, 'INTF': 0x1, 'IRP': 0x7,
       'VRHEN': 0x7, 'CCP1IE': 0x2, 'CCP1X': 0x5,
       'CCP1Y': 0x4, 'CSRC': 0x7, 'TX9': 0x6,
       'VRHOEN': 0x5, 'TMR2ON': 0x2, 'TMR1IF': 0x0,
       'IBOV': 0x5, 'SSPM0': 0x0, 'SSPM1': 0x1,
       'SSPM2': 0x2, 'SSPM3': 0x3, 'LV3': 0x3,
       'LV2': 0x2, 'I2C_START': 0x3, 'NOT_ADDRESS': 0x5,
