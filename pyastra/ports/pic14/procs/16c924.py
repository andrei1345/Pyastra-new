############################################################################
# $Id: 16c924.py 70 2004-08-23 01:34:19Z estyler $
#
# Description: PIC 16C924 definition. Pyastra project.
...
hdikt={'NOT_T1SYNC': 0x2, 'CKE': 0x6, 'BF': 0x0,
       'LMUX1': 0x1, 'CKP': 0x4, 'T2CON': 0x12,
       'T1CON': 0x10, 'PSPMODE': 0x4, 'T0SE': 0x4,
       'NOT_POR': 0x1, 'LP3': 0x3, 'LP2': 0x2,
       'LP1': 0x1, 'LP0': 0x0, 'PCFG2': 0x2,
       ...
       'SMP': 0x7, 'T0CS': 0x5, 'SSPBUF': 0x13,
       'GO_DONE': 0x2, 'SLPEN': 0x6, 'STATUS': 0x3,
       'PEIE': 0x6, 'SSPIE': 0x3, 'SSPIF': 0x3,
       'T2CKPS0': 0x0, 'T2CKPS1': 0x1, 'T1CKPS0': 0x4,
       'VGEN': 0x4, 'PCL': 0x2, 'PS2': 0x2,
       ...
       'CHS2': 0x5, 'TRISC': 0x87, 'ADCON1': 0x9f,
       'TRISA': 0x85, 'TRISG': 0x188, 'TRISF': 0x187,
       'TRISE': 0x89, 'LCDIF': 0x7, 'OPTION_REG': 0x81,
       'LCDIE': 0x7, 'TRISD': 0x88, 'DATA_ADDRESS': 0x5,
       'PIR1': 0xc, 'LCDPS': 0x10e, 'INTE': 0x4,
       'LCDD12': 0x11c, 'LCDD13': 0x11d, 'LCDD10': 0x11a,
       'LCDD11': 0x11b, 'S': 0x3, 'LCDD14': 0x11e,
       'LCDD15': 0x11f, 'UA': 0x1, 'RBIF': 0x0,
       'RBIE': 0x3, 'T1OSCEN': 0x3, 'R_W': 0x2,
       'LMUX0': 0x0, 'PCLATH': 0xa, 'SSPSTAT': 0x94,
       'PCON': 0x8e, 'TOUTPS2': 0x5, 'TOUTPS3': 0x6,
       'TOUTPS0': 0x3, 'TOUTPS1': 0x4, 'FSR': 0x4,
       'TRISE2': 0x2, 'TRISE1': 0x1, 'TRISE0': 0x0,
       'NOT_W': 0x2, 'SSPOV': 0x6, 'T0IF': 0x2,
       'LCDD09': 0x119, 'LCDD08': 0x118, 'CCP1CON': 0x17,
       'ADCS0': 0x6, 'ADRES': 0x1e, 'LCDD01': 0x111,
       ...
       'NOT_TO': 0x4, 'SE0': 0x0, 'OBF': 0x6,
       'TMR2IE': 0x1, 'TMR2IF': 0x1, 'R': 0x2,
       'ADIE': 0x6, 'ADIF': 0x6, 'Z': 0x2,
       'NOT_WRITE': 0x2, 'SE27': 0x6, 'ADCON0': 0x1f,
       'SE20': 0x5, 'SSPADD': 0x93, 'NOT_DONE': 0x2,
       'SE29': 0x7, 'INTCON': 0xb, 'SSPCON': 0x14,
       'TMR2': 0x11, 'TMR0': 0x1, 'LCDSE': 0x10d,
       'CCPR1L': 0x15, 'READ_WRITE': 0x2, 'PSA': 0x3,
