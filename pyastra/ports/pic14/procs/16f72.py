############################################################################
# $Id: 16f72.py 70 2004-08-23 01:34:19Z estyler $
#
# Description: PIC 16F72 definition. Pyastra project.
...
hdikt={'NOT_T1SYNC': 0x2, 'CKE': 0x6, 'BF': 0x0,
       'PMCON1': 0x18c, 'CKP': 0x4, 'T2CON': 0x12,
       'T1CON': 0x10, 'T0SE': 0x4, 'NOT_POR': 0x1,
       'RD': 0x0, 'PCFG2': 0x2, 'PCFG1': 0x1,
       ...
       'SSPBUF': 0x13, 'GO_DONE': 0x2, 'STATUS': 0x3,
       ...
       'CCP1M1': 0x1, 'TMR1CS': 0x1, 'CCP1IF': 0x2,
       ...
       'DATA_ADDRESS': 0x5, 'PIR1': 0xc, 'INTE': 0x4,
       ...
       'SSPM2': 0x2, 'SSPM3': 0x3, 'PMADRL': 0x10d,
