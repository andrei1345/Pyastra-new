############################################################################
# $Id: 16c771.py 70 2004-08-23 01:34:19Z estyler $
#
# Description: PIC 16C771 definition. Pyastra project.
...
hdikt={'NOT_T1SYNC': 0x2, 'CKE': 0x6, 'BF': 0x0,
       ...
       'NOT_W': 0x2, 'PMDATH': 0x10e, 'SSPOV': 0x6,
       'PMDATL': 0x10c, 'T0IF': 0x2, 'CCP1CON': 0x17,
       'ADCS0': 0x6, 'DATA_ADDRESS': 0x5, 'D_A': 0x5,
       'INTF': 0x1, 'ANSEL': 0x9d, 'VRHEN': 0x7,
       'TMR2IE': 0x1, 'TMR2IF': 0x1, 'NOT_BO': 0x0,
       'R': 0x2, 'ADIE': 0x6, 'ADIF': 0x6,
       'VRLEN': 0x6, 'Z': 0x2, 'NOT_WRITE': 0x2,
       'SSPADD': 0x93, 'NOT_DONE': 0x2, 'NOT_TO': 0x4,
       'SSPCON': 0x14, 'TMR2': 0x11, 'TMR0': 0x1,
       'VCFG0': 0x4, 'CCPR1L': 0x15, 'READ_WRITE': 0x2,
       'CCPR1H': 0x16, 'T0IE': 0x5, 'ADCS1': 0x7,
       'PEN': 0x2, 'NOT_PD': 0x3, 'DC': 0x1,
       'NOT_BOR': 0x0, 'LVDEN': 0x4, 'R_W': 0x2,
       'PS1': 0x1, 'LV1': 0x1, 'LV0': 0x0,
       'SSPEN': 0x5, 'ACKEN': 0x4, 'WPUB': 0x95,
       'WCOL': 0x7, 'RP1': 0x6, 'RP0': 0x5,
       'T1CKPS1': 0x5, 'T1CKPS0': 0x4, 'CCP1IF': 0x2,
       'CCP1IE': 0x2, 'VRHOEN': 0x5, 'TMR2ON': 0x2,
       'TMR1IF': 0x0, 'TMR1IE': 0x0, 'SSPM0': 0x0,
       'SSPM1': 0x1, 'SSPM2': 0x2, 'SSPM3': 0x3,
       'LV3': 0x3, 'PMADRL': 0x10d, 'LV2': 0x2,
       'I2C_START': 0x3, 'NOT_ADDRESS': 0x5, 'PMADRH': 0x10f,
       'INDF': 0x0, 'NOT_POR': 0x1, 'I2C_DATA': 0x5,
       }

pages=((0x5, 0x7FF), (0x800, 0x1000), )
